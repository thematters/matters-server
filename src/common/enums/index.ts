...
// values from https://observablehq.com/d/2e388b5a7f4c217a
export const RECOMMENDATION_HOTTEST_DAYS = 5
export const RECOMMENDATION_HOTTEST_MAX_TAKE = 200
