...
export const AUDIT_LOG_ACTION = {
  ...
  removeSocialAccountThreads: 'remove_social_account_threads',
  ...
  socialLoginThreads: 'social_login_threads',
  socialSignupThreads: 'social_signup_threads',
  ...
  addSocialAccountThreads: 'add_social_account_threads',
