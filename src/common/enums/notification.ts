...
export enum OFFICIAL_NOTICE_EXTEND_TYPE {
  ...
  community_watch_comment_restored = 'community_watch_comment_restored',
  community_watch_action_reversed = 'community_watch_action_reversed',
  community_watch_enabled = 'community_watch_enabled',
  community_watch_disabled = 'community_watch_disabled',
