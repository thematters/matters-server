...
const searchV1CoffA = environment.searchPgCoefficients?.[0] || 1
const searchV1CoffB = environment.searchPgCoefficients?.[1] || 1
const searchV1CoffC = environment.searchPgCoefficients?.[2] || 1
...
LIMIT ? OFFSET ?`,
        [searchV1CoffA, searchV1CoffB, searchV1CoffC, key, take, skip]
      ),
    ])
