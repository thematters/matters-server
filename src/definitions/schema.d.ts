...
import { User as UserModel, Wallet as WalletModel, OAuthClientDB as OAuthClientDBModel } from './user.js';
...
export type GQLResolversInterfaceTypes<_RefType extends Record<string, unknown>> = ResolversObject<{
  ...
  Connection: ( Omit<GQLAppreciationConnection, 'edges'> & { edges?: Maybe<Array<_RefType['AppreciationEdge']>> } ) | ( Omit<GQLArticleConnection, 'edges'> & { edges?: Maybe<Array<_RefType['ArticleEdge']>> } ) | ( Omit<GQLArticleVersionsConnection, 'edges'> & { edges: Array<Maybe<_RefType['ArticleVersionEdge']>> } ) | ( Omit<GQLCampaignArticleConnection, 'edges'> & { edges: Array<_RefType['CampaignArticleEdge']> } ) | ( Omit<GQLCampaignConnection, 'edges'> & { edges?: Maybe<Array<_RefType['CampaignEdge']>> } ) | ( Omit<GQLCampaignParticipantConnection, 'edges'> & { edges?: Maybe<Array<_RefType['CampaignParticipantEdge']>> } ) | ( Omit<GQLChannelArticleConnection, 'edges'> & { edges?: Maybe<Array<_RefType['ChannelArticleEdge']>> } ) | ( Omit<GQLCircleConnection, 'edges'> & { edges?: Maybe<Array<_RefType['CircleEdge']>> } ) | ( Omit<GQLCollectionConnection, 'edges'> & { edges?: Maybe<Array<_RefType['CollectionEdge']>> } ) | ( Omit<GQLCommentConnection, 'edges'> & { edges?: Maybe<Array<_RefType['CommentEdge']>> } ) | ( Omit<GQLDraftConnection, 'edges'> & { edges?: Maybe<Array<_RefType['DraftEdge']>> } ) | ( Omit<GQLFollowingActivityConnection, 'edges'> & { edges?: Maybe<Array<_RefType['FollowingActivityEdge']>> } ) | ( Omit<GQLIcymiTopicConnection, 'edges'> & { edges: Array<_RefType['IcymiTopicEdge']> } ) | ( Omit<GQLInvitationConnection, 'edges'> & { edges?: Maybe<Array<_RefType['InvitationEdge']>> } ) | ( Omit<GQLMemberConnection, 'edges'> & { edges?: Maybe<Array<_RefType['MemberEdge']>> } ) | ( Omit<GQLNoticeConnection, 'edges'> & { edges?: Maybe<Array<_RefType['NoticeEdge']>> } ) | ( Omit<GQLOAuthClientConnection, 'edges'> & { edges?: Maybe<Array<_RefType['OAuthClientEdge']>> } ) | ( Omit<GQLReadHistoryConnection, 'edges'> & { edges?: Maybe<Array<_RefType['ReadHistoryEdge']>> } ) | ( GQLRecentSearchConnection ) | ( Omit<GQLReportConnection, 'edges'> & { edges?: Maybe<Array<_RefType['ReportEdge']>> } ) | ( Omit<GQLResponseConnection, 'edges'> & { edges?: Maybe<Array<_RefType['ResponseEdge']>> } ) | ( Omit<GQLSearchResultConnection, 'edges'> & { edges?: Maybe<Array<_RefType['SearchResultEdge']>> } ) | ( GQLSkippedListItemsConnection ) | ( Omit<GQLTagConnection, 'edges'> & { edges?: Maybe<Array<_RefType['TagEdge']>> } ) | ( Omit<GQLTopDonatorConnection, 'edges'> & { edges?: Maybe<Array<_RefType['TopDonatorEdge']>> } ) | ( Omit<GQLTransactionConnection, 'edges'> & { edges?: Maybe<Array<_RefType['TransactionEdge']>> } ) | ( Omit<GQLUserConnection, 'edges'> & { edges?: Maybe<Array<_RefType['UserEdge']>> } ) | ( Omit<GQLWritingConnection, 'edges'> & { edges?: Maybe<Array<_RefType['WritingEdge']>> } );
  Node: ( ArticleModel ) | ( ArticleVersionModel ) | ( CircleModel ) | ( CollectionModel ) | ( CommentModel ) | ( DraftModel ) | ( MattersChoiceTopicModel ) | ( MomentModel ) | ( ReportModel ) | ( TagModel ) | ( UserModel ) | ( CampaignModel );
...
export type GQLResolversTypes = ResolversObject<{
  ...
  OSS: ResolverTypeWrapper<Omit<GQLOss, 'articles' | 'badgedUsers' | 'comments' | 'icymiTopics' | 'oauthClients' | 'reports' | 'restrictedUsers' | 'seedingUsers' | 'tags' | 'users'> & { articles: GQLResolversTypes['ArticleConnection'], badgedUsers: GQLResolversTypes['UserConnection'], comments: GQLResolversTypes['CommentConnection'], icymiTopics: GQLResolversTypes['IcymiTopicConnection'], oauthClients: GQLResolversTypes['OAuthClientConnection'], reports: GQLResolversTypes['ReportConnection'], restrictedUsers: GQLResolversTypes['UserConnection'], seedingUsers: GQLResolversTypes['UserConnection'], tags: GQLResolversTypes['TagConnection'], users: GQLResolversTypes['UserConnection'] }>;
  ...
  TopDonatorEdge: ResolverTypeWrapper<Omit<GQLTopDonatorEdge, 'node'> & { node: GQLResolversTypes['User'] }>;
...
export type GQLResolversParentTypes = ResolversObject<{
  ...
  TopDonatorEdge: Omit<GQLTopDonatorEdge, 'node'> & { node: GQLResolversParentTypes['User'] };
  TopDonatorFilter: GQLTopDonatorFilter;
  TopDonatorInput: GQLTopDonatorInput;
...
export type GQLArticleResolvers<ContextType = Context, ParentType extends GQLResolversParentTypes['Article'] = GQLResolversParentTypes['Article']> = ResolversObject<{
  ...
  collectedBy?: Resolver<GQLResolversTypes['ArticleConnection'], ParentType, ContextType, RequireFields<GQLArticleCollectedByArgs, 'input'>>;
...
export type GQLArticleOssResolvers<ContextType = Context, ParentType extends GQLResolversParentTypes['ArticleOSS'] = GQLResolversParentTypes['ArticleOSS']> = ResolversObject<{
  ...
  topicChannels?: Resolver<Array<GQLResolversTypes['ArticleTopicChannel']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type GQLChannelResolvers<ContextType = Context, ParentType extends GQLResolversParentTypes['Channel'] = GQLResolversParentTypes['Channel']> = ResolversObject<{
  __resolveType: TypeResolveFn<'CurationChannel' | 'TopicChannel' | 'WritingChallenge', ParentType, ContextType>;
}>;
...
export type GQLConnectionResolvers<ContextType = Context, ParentType extends GQLResolversParentTypes['Connection'] = GQLResolversParentTypes['Connection']> = ResolversObject<{
  __resolveType: TypeResolveFn<'AppreciationConnection' | 'ArticleConnection' | 'ArticleVersionsConnection' | 'CampaignArticleConnection' | 'CampaignConnection' | 'CampaignParticipantConnection' | 'ChannelArticleConnection' | 'CircleConnection' | 'CollectionConnection' | 'CommentConnection' | 'DraftConnection' | 'FollowingActivityConnection' | 'IcymiTopicConnection' | 'InvitationConnection' | 'MemberConnection' | 'NoticeConnection' | 'OAuthClientConnection' | 'ReadHistoryConnection' | 'RecentSearchConnection' | 'ReportConnection' | 'ResponseConnection' | 'SearchResultConnection' | 'SkippedListItemsConnection' | 'TagConnection' | 'TopDonatorConnection' | 'TransactionConnection' | 'UserConnection' | 'WritingConnection', ParentType, ContextType>;
}>;
...
export type GQLMutationResolvers<ContextType = Context, ParentType extends GQLResolversParentTypes['Mutation'] = GQLResolversParentTypes['Mutation']> = ResolversObject<{
  ...
  setSpamStatus?: Resolver<GQLResolversTypes['Article'], ParentType, ContextType, RequireFields<GQLMutationSetSpamStatusArgs, 'input'>>;
  ...
  togglePinChannelArticles?: Resolver<GQLResolversTypes['Channel'], ParentType, ContextType, RequireFields<GQLMutationTogglePinChannelArticlesArgs, 'input'>>;
...
export type GQLNodeResolvers<ContextType = Context, ParentType extends GQLResolversParentTypes['Node'] = GQLResolversParentTypes['Node']> = ResolversObject<{
  __resolveType: TypeResolveFn<'Article' | 'ArticleVersion' | 'Circle' | 'Collection' | 'Comment' | 'Draft' | 'IcymiTopic' | 'Moment' | 'Report' | 'Tag' | 'User' | 'WritingChallenge', ParentType, ContextType>;
}>;
...
export type GQLTagResolvers<ContextType = Context, ParentType extends GQLResolversParentTypes['Tag'] = GQLResolversParentTypes['Tag']> = ResolversObject<{
  articles?: Resolver<GQLResolversTypes['ArticleConnection'], ParentType, ContextType, RequireFields<GQLTagArticlesArgs, 'input'>>;
  content?: Resolver<GQLResolversTypes['String'], ParentType, ContextType>;
  createdAt?: Resolver<GQLResolversTypes['DateTime'], ParentType, ContextType>;
