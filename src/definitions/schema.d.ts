...
export interface GQLConnectionTypeResolver<TParent = any> {
  (parent: TParent, context: Context, info: GraphQLResolveInfo): 'ArticleConnection' | 'ResponseConnection' | 'CommentConnection' | 'TagConnection' | 'UserConnection' | 'DraftConnection' | 'ReadHistoryConnection' | 'RecentSearchConnection' | 'TransactionConnection' | 'NoticeConnection' | 'SearchResultConnection' | 'ReportConnection' | 'OAuthClientConnection';
}
