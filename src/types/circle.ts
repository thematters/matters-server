...
export default /* GraphQL */ `
  ...
  extend type Mutation {
    ...
    "Subscribe a Circle."
    subscribeCircle(input: CircleSubscriptionInput!): SubscribeCircleResult! @auth(mode: "${MODE.oauth}", group: "${GROUP.level3}")

    "Unsubscribe a Circle."
    unsubscribeCircle(input: CircleSubscriptionInput!): Circle! @auth(mode: "${MODE.oauth}", group: "${GROUP.level3}")
  }
