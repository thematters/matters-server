...
export default /* GraphQL */ `
  ...
  type Recommendation {
    ...
    topicArticles(input: TopicArticlesInput!): ArticleConnection! @complexity(multipliers: ["input.first"], value: 1) @cacheControl(maxAge: ${CACHE_TTL.PUBLIC_FEED_ARTICLE})
